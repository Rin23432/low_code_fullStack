        ...
        {!ssrRendered && (
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            ...
            <div className="grid grid-cols-3 gap-4 text-sm">
              <div>
                <span className="font-medium">首次渲染:</span>{" "}
                {performanceMetrics.firstRender.toFixed(2)}ms
              </div>
              <div>
                <span className="font-medium">数据加载:</span>{" "}
                {performanceMetrics.dataLoad.toFixed(2)}ms
              </div>
              <div>
                <span className="font-medium">总时间:</span>{" "}
